<template>
  <div :class="[tip == 'no-auth' ? '' : 'container']" class="footer">
    <footer class="py-3">
      <ul class="nav justify-content-center border-bottom pb-3 mb-3">
        <li class="nav-item">
          <a href="/StudBud/index.php" class="nav-link px-2 text-muted">Home</a>
        </li>
        <li class="nav-item">
          <a href="/StudBud/contact.php" class="nav-link px-2 text-muted"
            >Contact</a
          >
        </li>
        <li class="nav-item">
